...
describe('validateErrors', () => {
    test('invalid user data', () => {
        expect(
            validateErrors({ ...data, first: undefined, lastname: undefined }),
        ).toEqual([ValidateProfileError.INVALID_USER_DATA])
    })
    ...
    test('no user data', () => {
        expect(validateErrors()).toEqual([ValidateProfileError.NO_DATA])
    })
